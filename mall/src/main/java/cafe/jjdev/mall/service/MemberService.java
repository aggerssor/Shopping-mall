...
public class MemberService {
	...
	public int addMember(Member member) {
		...
		if(result == 1) {
			System.out.println("가입한 아이디중 중복되는 값이 있습니다. : " + result);
		} else if(result2 == 1) {
			System.out.println("탈퇴한 아이디중 중복되는 값이 있습니다.  : " + result2);
		}
	
		int re = result + result2;
		
		if(re >= 1) {
			System.out.println("중복된아이디가있습니다");
			
			return re;
		} else {
			System.out.println("중복된아이디가없습니다");
